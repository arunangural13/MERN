...
const ViewMember = () => {
  ...
  return (
    <div>
      ...
      {/* Main Content */}
      <main className="p-5 bg-white" style={{ marginLeft: "215px", minHeight: "100vh",width:"85%" }}>
                  ...
                  {memberList.map((member) => (
                    <tr key={member._id}>
                      ...
                      <td>
                        {member.image && (
                          <img
                            src={`http://localhost:2000/uploads/${member.image}`}
                            alt="Member"
                            width="50"
                          />
                        )}
                      ...
                      <td>
                        {member.addressProof && (
                          <a
                            href={`http://localhost:2000/uploads/${member.addressProof}`}
                            target="_blank"
                            rel="noreferrer"
                          >
                            View
                      ...
                      <td>
                        {member.idProof && (
                          <a
                            href={`http://localhost:2000/uploads/${member.idProof}`}
                            target="_blank"
                            rel="noreferrer"
                          >
                            View
