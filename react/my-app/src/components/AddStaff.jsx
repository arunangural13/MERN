...
const AddStaff = () => {
  ...
  const fetchStaff = async () => {
    try {
      const response = await axios.post("http://localhost:2000/api/getallstaff");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (editMode) {
        // update staff
        const response = await axios.post("http://localhost:2000/api/getupdatestaffbyid",{
            id:editId,
            ...formData
        }) 
        console.log(response);
        ...
        // add staff
        const response = await axios.post("http://localhost:2000/api/addstaff", formData);
        console.log(response);
  ...
  const handleDelete = async (id) => {
    if (window.confirm("Are you sure you want to delete this staff?")) {
      try {
        await axios.post("http://localhost:2000/api/deletestaff",{id});
