...
const addFund = async (req, res) => {
  try {
    const { title, description, startDate, endDate, amount } = req.body;
    const validation = [];

    if (!title) validation.push("title is required");
    ...
    const fund = new Fund({ title, description, startDate, endDate, amount });
